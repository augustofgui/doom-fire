...
const fireWidth = window.innerWidth / 5;
const fireHeight = fireWidth / 10;
...
canvasFooter.width = fireWidth;
canvasFooter.height = fireHeight;
...
function renderFire() {
  for (let row = 0; row < fireHeight; row++) {
    for (let column = 0; column < fireWidth; column++) {
      ...
      contextFooter.fillRect(column, row, 1, 1);
    }
  }
